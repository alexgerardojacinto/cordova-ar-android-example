...
import examples.java.common.samplerender.arcore.PlaneRenderer
import examples.java.common.samplerender.arcore.SpecularCubemapFilter
...
class HelloArRenderer(val activity: HelloArActivity) :
  ...
  private fun handleTap(frame: Frame, camera: Camera) {
    ...
    val tap : MotionEvent = activity.view.tapHelper.poll() ?: return
